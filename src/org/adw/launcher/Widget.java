...
class Widget extends ItemInfo {
    ...
    static Widget makeRemindCalendar() {
        Widget w = new Widget();
        w.itemType = LauncherSettings.Favorites.ITEM_TYPE_WIDGET_REMIND_CALENDAR;
        w.spanX = 4;
        w.spanY = 4;
        w.layoutResource = R.layout.widget_remind_calendar;
        w.name = "动机提醒日历";
        return w;
    }
}
