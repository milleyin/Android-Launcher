...
class LauncherSettings {
    ...
    static final class Favorites implements BaseLauncherColumns {
         ...
         * 提醒日历
         */
        static final int ITEM_TYPE_WIDGET_REMIND_CALENDAR = 1003;
        
        /**
         * 时钟
         */
        static final int ITEM_TYPE_WIDGET_CALENDAR = 1004;
        
        /**
         * 天气
         */
        static final int ITEM_TYPE_WIDGET_WEATHER = 1005;
        
        /**
         * 云应用
         */
		static final int ITEM_TYPE_WIDGET_CLOUD_APP = 1006;
		
		/**
		 * 任务管理器
		 */
		static final int ITEM_TYPE_WIDGET_TASK_MANAGER = 1007;
		
		/**
		 * 我的应用
		 */
		static final int ITEM_TYPE_WIDGET_MY_APP = 1008;
         ...
         * 用户选择的模式
         */
        static final String SELECT_MODE="mode";
    }
}
