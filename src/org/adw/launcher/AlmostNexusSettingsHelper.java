...
public final class AlmostNexusSettingsHelper {
	...
	public static int getDesktopScreens(Context context) {
		SharedPreferences sp = context.getSharedPreferences(ALMOSTNEXUS_PREFERENCES, Context.MODE_PRIVATE);
		int screens=0 ;
		if(Launcher.stateMod==0)
		{
			screens = sp.getInt("desktopScreens", context.getResources().getInteger(R.integer.config_desktopScreens));
		}
		else if(Launcher.stateMod==1)
		{
			screens = sp.getInt("desktopScreensCustomer", context.getResources().getInteger(R.integer.config_desktopScreens));
		}
		else if(Launcher.stateMod==2)
		{
			screens = sp.getInt("desktopScreensAll", context.getResources().getInteger(R.integer.config_desktopScreens));
		}
	...
	public static int getDesktopColumns(Context context) {
		SharedPreferences sp = context.getSharedPreferences(ALMOSTNEXUS_PREFERENCES, Context.MODE_PRIVATE);
		int screens = sp.getInt("desktopColumns", context.getResources().getInteger(R.integer.config_desktopColumns));
		return screens;
	}
	public static int getDesktopRows(Context context) {
		SharedPreferences sp = context.getSharedPreferences(ALMOSTNEXUS_PREFERENCES, Context.MODE_PRIVATE);
		int screens = sp.getInt("desktopRows", context.getResources().getInteger(R.integer.config_desktopRows));
		return screens;
	}
	...
	public static void setDesktopScreens(Context context,int screens,int mode) {
	    ...
	    if(mode==0)
	    {
	    	editor.putInt("desktopScreens", screens);
	    }else if(mode==1)
	    {
	    	editor.putInt("desktopScreensCustomer", screens);
	    }
	    else if(mode==2)
	    {
	    	editor.putInt("desktopScreensAll", screens);
	    }
	    editor.commit();
		
	}
	public static void setDesktopRows(Context context,int rows) {
		SharedPreferences sp = context.getSharedPreferences(ALMOSTNEXUS_PREFERENCES, Context.MODE_PRIVATE);
		SharedPreferences.Editor editor = sp.edit();
		editor.putInt("desktopRows", rows);
	    editor.commit();
	}
	public static void setDesktopColumns(Context context,int columns) {
		SharedPreferences sp = context.getSharedPreferences(ALMOSTNEXUS_PREFERENCES, Context.MODE_PRIVATE);
		SharedPreferences.Editor editor = sp.edit();
		editor.putInt("desktopColumns", columns);
	    editor.commit();
	}
	...
	public static class ChangelogDialogBuilder {
		public static AlertDialog create( Context context ) throws NameNotFoundException {
			...
			return new AlertDialog.Builder(context).setTitle(aboutTitle).setCancelable(true).setIcon(R.drawable.dongji_ico).setPositiveButton(
