 ...
 */
public class ApplicationInfo extends ItemInfo implements Cloneable{
    /**
    ...
    public ApplicationInfo(ApplicationInfo info) {
        super(info);
        assignFromApplicationInfo(info);
    }

	void assignFromApplicationInfo(ItemInfo info) {
    	if (info instanceof ApplicationInfo)
    	{
	        ...
	        mSortEntity.id=nfo.mSortEntity.id;
	        mSortEntity.itemType=nfo.mSortEntity.itemType;
	        mSortEntity.openNumber=nfo.mSortEntity.openNumber;
	        mSortEntity.openTime=nfo.mSortEntity.openTime;
	        mSortEntity.packageName=nfo.mSortEntity.packageName;
	        mSortEntity.visible=nfo.mSortEntity.visible;
    	}
    }
