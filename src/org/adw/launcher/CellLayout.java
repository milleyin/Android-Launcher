...
public class CellLayout extends WidgetCellLayout implements Cloneable  {
	...
	public  List<Point> vaild_points;
...
//        	System.out.println( " CellLayout  --->  ACTION_DOWN");
...
//                        System.out.println("  cellInfo.cellX  " +   cellInfo.cellX);
//                        System.out.println("  cellInfo.cellY  " +   cellInfo.cellY);
//                        System.out.println("  cellInfo.spanX  " +   cellInfo.spanX);
//                        System.out.println("  cellInfo.spanY  " +   cellInfo.spanY);
                        break;
                    }
                }
            }
...
//        	System.out.println( " CellLayout  --->  ACTION_UP");
...
//            System.out.println(" action == MotionEvent.ACTION_UP ");
        }
...
//            System.out.println(" height is---->" + getHeight());
            ...
            //所有的子View的位置矩阵 
            List<Rect> childRects = new ArrayList<Rect>();
            ...
            System.out.println("  getPaddingBottom() " + getPaddingBottom());
            ...
            System.out.println("  mCellWidth  --->" + mCellWidth);
            System.out.println(" mCellHeight --->" + mCellHeight);
            
            System.out.println("  mWidthGap  --->" + mWidthGap);
            System.out.println(" mHeightGap --->" + mHeightGap);
...
//            private int mHeightGap;
            ...
            int x_gap = mCellWidth+mWidthGap;
            int y_gap = mCellHeight+mHeightGap;
            
            int p_x =0;
            int p_y =0;
            
            System.out.println("  x_gap  --->" +x_gap);
            System.out.println(" y_gap --->" + y_gap);
            ...
            for(int i = 0 ; i<mColumns; i ++)
            {
            	...
            	{
            		boolean b = true;
            		for(Rect r:childRects)
                	{
                		if(r.contains(p_x+10, p_y+10))
                		{
                			b = false;
                			break;
                		}
            ...
            if(isHaveSpace)
            {
            	System.out.println("  center_x  --->" + (p_x+10) + "  center_y  --->" + (p_y+10));
            	 ...
            	 int cellXY[] = mCellXY;
                 pointToCellExact(p_x+10, p_y+10, cellXY);
...
//        int y_gap = mCellHeight+mHeightGap;
        ...
        int x_gap = getWidth() / mColumns;
        int y_gap =  getHeight() /mRows;
        
        int p_x =0;
        int p_y =0;
        
        vaild_points = new ArrayList<Point>();
        List<Point> used_points = new ArrayList<Point>();
        
        for(int i = 0 ; i<mColumns; i ++)
        {
        	for(int j = 0 ;j<mRows ; j++)
        	{
        		Point p = new Point(p_x+10, p_y+10);
        		vaild_points.add(p);
        ...
        vaild_points.removeAll(used_points); //移除已经被占用的
        
        for(Point p :vaild_points)
        {
        	int [] result = new int [2];
        	pointToCellExact(p.x, p.y, result);
        	
        	System.out.println(" result  ---> cellX:" + result[0]  + " cellY:" + result[1]);
        }
        
        return used_points.size();
    }
